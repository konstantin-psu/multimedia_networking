...
\end{homeworkProblem}
\begin{homeworkProblem}
Suppose we have a set of frames (number 1 ... n) that we would like to compress
into MPEG-1 with the following frame types:\\
...
Assuming, they all fit into one group of pictures (GOP), what order do these
frames appear in the compressed stream?
